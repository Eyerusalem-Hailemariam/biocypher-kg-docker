...
def main(output_dir: Annotated[Path, typer.Option(exists=True, file_okay=False, dir_okay=True)], 
         ...
         write_properties: bool = typer.Option(False, help="Write properties to nodes and edges"),
         add_provenance: bool = typer.Option(False, help="Add provenance to nodes and edges"),
